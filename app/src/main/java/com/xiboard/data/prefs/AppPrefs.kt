...
package com.xiboard.data.prefs
...
import com.xiboard.ime.candidates.compact.CompactCandidateMode
import com.xiboard.ime.candidates.popup.PopupCandidatesLayout
import com.xiboard.ime.candidates.popup.PopupCandidatesMode
import com.xiboard.ime.composition.PopupPosition
import com.xiboard.ime.core.InlinePreeditMode
...
class AppPrefs(
    ...
    class General(
        ...
        companion object {
            ...
            const val OFFLINE_VOICE_INPUT = "offline_voice_input"
        ...
        val offlineVoiceInput = switch(
            R.string.offline_voice_input,
            OFFLINE_VOICE_INPUT,
            true,
            R.string.offline_voice_input_enabled,
        )
