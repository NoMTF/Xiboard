...
import com.xiboard.core.KeyValue
...
import com.xiboard.data.prefs.PreferenceDelegate
import com.xiboard.data.prefs.PreferenceDelegateProvider
...
import com.xiboard.util.findSectionFrom
import com.xiboard.util.forceShowSelf
import com.xiboard.util.monitorCursorAnchor
import com.xiboard.util.styledFloat
...
open class TrimeInputMethodService : LifecycleInputMethodService() {
    ...
    fun finishVoiceComposingText(finalText: String) {
        val ic = currentInputConnection ?: return
        ic.beginBatchEdit()
