...
class InputView(
    ...
    private val offlineVoiceWindow: OfflineVoiceWindow by di.instance()
    ...
    init {
        ...
        windowManager.cacheResidentWindow(offlineVoiceWindow)
        // show KeyboardWindow by default
        windowManager.attachWindow(KeyboardWindow)
        if (AppPrefs.defaultInstance().general.offlineVoiceInput.getValue()) {
            offlineVoiceInputController.warmUp()
        }
